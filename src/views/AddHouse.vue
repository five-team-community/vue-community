    ...
    <div class="content">
      ...
      { type: 'number', message: '面积必须为数字值', trigger: ['blur','change']}]"
        ...
        <el-form-item
          label="户型:"
          prop="type"
          :rules="{ required: true, message: '户型不能为空', trigger: ['blur','change']}"
        >
        ...
        <el-form-item
          label="房产性质"
          prop="nature"
          :rules="{ required: true, message: '房产性质不能为空', trigger: ['blur','change']}"
        >
        ...
        <el-form-item
          label="交房时间:"
          :rules="{ required: true, message: '交房时间不能为空', trigger: ['blur','change']}"
        >
          <el-date-picker
