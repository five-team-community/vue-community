      ...
      <el-table :data="userData" border style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="primary" icon="el-icon-search" size="mini" @click="show(scope.$index)"></el-button>
            <el-button
              type="info"
            ...
            <el-button
              ...
              icon="el-icon-unlock"
              size="mini"
              @click="lock(scope.$index)"
              v-show="userData[scope.$index].state=='正常'"
            ></el-button>
            <el-button
              type="danger"
              icon="el-icon-lock"
              size="mini"
              @click="unlock(scope.$index)"
              v-show="userData[scope.$index].state=='禁用'"
            ></el-button>
          </template>
        </el-table-column>
      </el-table>
